        ...
        {loading ? (
          ...
          <p className="text-center py-20 text-gray-500">
            {searchQuery && searchQuery.trim().length > 0
              ? `No properties found for "${searchQuery}". Try adjusting your search.`
          ...
          <div className="mt-14 flex justify-center items-center gap-2 sm:gap-3">
            ...
            {Array.from(
              ...
              <button
                ...
                className={`h-10 w-10 sm:h-12 sm:w-12 rounded-full text-sm sm:text-base font-medium ${page === pageNumber
